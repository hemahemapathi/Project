...
// Import useNavigate() to navigate the user programmatically
...
const FeatureForm = ({ projectId, teamMembers }) => {
  // Use useNavigate() to navigate the user programmatically
  ...
  const handleFormSubmit = async (event) => {
    ...
    // Navigate to the current page (effectively reloads it)
    navigate(0);
  };
